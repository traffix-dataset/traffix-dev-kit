...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="TrafficX_dataset/r01_full_split/test_full/labels_point_clouds/TrafficX_lidar_ouster_south_and_north_merged_with_origin_in_south",
    )
    ...
    parser.add_argument(
        ...
        default="TrafficX_dataset/r01_full_split/test_full/labels_point_clouds/TrafficX_lidar_ouster_south_and_north_merged_with_origin_in_south_filtered_for_south2_fov_with_tracking_in_lidar",
    )
    ...
    parser.add_argument(
        ...
        default="camera_basler_south2_8mm.json",
    )

    parser.add_argument(
        "--coordinate_system_origin",
        type=str,
        help="Coordinate system origin. Possible values: [lidar_ouster_south, lidar_ouster_north, TrafficX_base]",
