...
if __name__ == "__main__":
    ...
    subsets = ["TrafficX_dataset_r02_s01", "TrafficX_dataset_r02_s02", "TrafficX_dataset_r02_s03", "TrafficX_dataset_r02_s04"]
    sensor_modalities = ["point_clouds", "images", "labels_point_clouds"]
    camera_sensors = ["camera_basler_south2_8mm", "camera_basler_south1_8mm"]
    lidar_sensors = ["lidar_ouster_south", "lidar_ouster_north"]
