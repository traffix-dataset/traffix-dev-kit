...
# Usage:
#           python TrafficX-dev-kit/undistort_images.py --input_folder_path_images <INPUT_FOLDER_PATH_IMAGES> \
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        default="TrafficX_dataset/r01_s01/_images/s040_camera_basler_north_16mm",
        help="Input folder path of images. Default: TrafficX_dataset/r01_s01/_images/s040_camera_basler_north_16mm",
    )
    argparser.add_argument(
        "-l",
        "--file_path_calibration_parameter",
        default="TrafficX_dataset/r00_s00/_calibration/s40_camera_basler_north_16mm.json",
        help="File path to calibration parameter file (json). Default: TrafficX_dataset/r01_s01/_calibration/s40_camera_basler_north_16mm.json",
    )
    argparser.add_argument(
        "-o",
        "--output_folder_path_images",
        help="Output folder path to undistorted/rectified camera images. Default: TrafficX_dataset/r01_s01/_images_undistorted/s040_camera_basler_north_16mm",
    )
