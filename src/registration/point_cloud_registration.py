...
if __name__ == "__main__":
    ...
    loss_best = sys.maxsize
    if (
        "lidar_ouster_north" in args.folder_path_point_cloud_source
        and "lidar_ouster_south" in args.folder_path_point_cloud_target
    ):
        ...
        "lidar_ouster_south" in args.folder_path_point_cloud_source
        and "lidar_ouster_north" in args.folder_path_point_cloud_target
    ):
        ...
        print("ERROR: unknown lidar pair. Supported LiDAR IDs are: [lidar_ouster_south, lidar_ouster_north]")
        exit(1)
        ...
        if bool(args.save_registered_point_clouds):
            ...
            if store_fitness:
                ...
                file_name = (
                    ...
                    + "_"
                    + str(nano_seconds).zfill(9)
                    + "_TrafficX_lidar_ouster_south_and_north_registered.pcd"
                )
            write_point_cloud_with_intensity(
