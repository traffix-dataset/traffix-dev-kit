...
if __name__ == "__main__":
    ...
    classes_list = ["CAR", "TRUCK", "TRAILER", "VAN", "MOTORCYCLE", "BUS", "PEDESTRIAN", "BICYCLE", "EMERGENCY_VEHICLE", "OTHER"]
    ...
    plt.subplots_adjust(left=0.13, right=0.99, top=0.97, bottom=0.42)
    ...
    plt.ylabel(r"$\emptyset$ track length [in m]", fontsize=12)
    # set y ticks
