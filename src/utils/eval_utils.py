...
def parse_arguments():
    argparser = argparse.ArgumentParser(description="Evaluating TrafficX-Dataset R2 Release")
    ...
    argparser.add_argument(
        ...
        type=str,
        default=None,
        help="Provide the camera ID you want to use for evaluation. Possible values are: [camera_basler_south1_8mm, camera_basler_south2_8mm]",
    )
