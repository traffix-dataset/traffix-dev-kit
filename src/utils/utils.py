...
# Mapping object class name to TrafficX dataset class ID
...
# MS COCO ID to TrafficX ID mapping
ms_coco_to_TrafficX_mapping = {
    "0": {
        "class_id": 6,  # person ID=0 in MS COCO is mapped to pedestrian ID=6 in TrafficX dataset
        "color_rgb": (249, 118, 233),
        "class_label_de": "Person",
        "class_label_en": "Pedestrian",
    },
    "1": {
        "class_id": 7,  # bicycle ID=1 in MS COCO is mapped to bike ID=7 in TrafficX dataset
        "color_rgb": (255, 140, 177),
        "class_label_de": "Fahrrad",
        "class_label_en": "Bicycle",
    },
    "2": {
        "class_id": 0,  # car ID=2 in MS COCO is mapped to car ID=0 in TrafficX dataset
        "color_rgb": (246, 204, 0),
        "class_label_de": "PKW",
        "class_label_en": "Car",
    },
    "3": {
        "class_id": 4,  # motorcycle ID=3 in MS COCO is mapped to motorcycle ID=4 in TrafficX dataset
        "color_rgb": (84, 164, 185),
        "class_label_de": "Motorrad",
        "class_label_en": "Motorcycle",
    },
    "5": {
        "class_id": 5,  # bus ID=5 in MS COCO is mapped to bus ID=5 in TrafficX dataset
        "color_rgb": (134, 138, 217),
        "class_label_de": "Bus",
        "class_label_en": "Bus",
    },
    "7": {
        "class_id": 1,  # truck ID=7 in MS COCO is mapped to truck ID=1 in TrafficX dataset
