...
# Conversion for TrafficX dataset (release 0 and 1) to Yolo format
# Example:
# python conversion_openlabel_to_yolo.py --input_folder_path_labels TrafficX_dataset_r00_s01/_labels --output_folder_path_labels TrafficX_dataset_r00_s01/_labels_yolo
...
def convert_file(input_folder_path_labels, output_folder_path_labels, filename, export_format):
    ...
    if "openlabel" in data:
        # converting TrafficX Release 1 or higher to Yolo
        ...
        # converting TrafficX Release 0 to Yolo
...
def convert_TrafficX_to_mscoco(input_folder_path_labels, output_folder_path_labels, export_format):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Specify the export format of the class IDs. Possible values: [custom_training, transfer_learning]. custom_training: Use IDs from TrafficX dataset to train from scratch. transfer_learning: Use IDs from MS COCO dataset to do transfer learning.",
    )
    ...
    convert_TrafficX_to_mscoco(input_folder_path_labels, output_folder_path_labels, export_format)
